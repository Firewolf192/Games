        ...
        while running:
            ...
            if self.game_over:
                ...
                if reset.collidepoint(mouse_pos):
                    ...
                    if pygame.mouse.get_pressed()[0]:
                        self.reset = RestardGame(self.ship.speed, )
            ...
            if self.alien.wave1:
                if all(not alien["alive"] for alien in self.alien.alien_army[:]):
                    self.alien.alien_army.clear()
                    self.alien.spawn_second_wave()
                    self.alien.wave1 = False
                    self.alien.wave2 = True

            if self.alien.wave2:
                if all(not alien["alive"] for alien in self.alien.alien_army[:]):
                    self.alien.alien_army.clear()
                    self.alien.spawn_first_wave()
                    self.alien.wave2 = False
